	  ...
	  (0, _createClass3.default)(State, [{
	    ...
	    value: function render() {
	      ...
	      return _react3.default.createElement(
	        'div',
	        { className: 'main' },
	        loading ? '正在努力加载中...' : error ? '网络错误，请稍后重试...' : data.msg === '登陆验证失败' ? _react3.default.createElement(
	          'p',
	          null,
	          '登陆验证失败,请 ',
	  ...
	  (0, _createClass3.default)(State, [{
	    ...
	    value: function render() {
	      ...
	      return _react3.default.createElement(
	        'section',
	        { className: 'contents' },
	        loading ? '正在努力加载中...' : error ? '网络错误，请稍后重试...' : data.status !== 'success' ? data.msg : ''
	      );
	    }
	  }]);
	  return State;
...
//# sourceMappingURL=app-f0c13400a73dac5d9260.js.map